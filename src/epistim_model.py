...
def _numba_dfun(y, c_pop, x0, Iext, a, b, tt, Kvf, c, d, r, r2, Ks, Kf, modification, Istim, threshold, ydot):
    ...
    # H = heaviside_impl(y[3] - threshold[0], 1.0)  # Method 1 : using heaviside function
    H = sigmoid_impl((y[3] - threshold[0]))         # Method 2 : using sigmoid function with high steepness
...
class EpileptorStim(ModelNumbaDfun):
    ...
    def dfun(self, x, c, local_coupling=0.0, stimulus=0.0):
        ...
        deriv = _numba_dfun(x_, c_,
                         ...
                         self.c, self.d, self.r, self.r2, self.Ks, self.Kf, self.modification, self.Istim, self.threshold)
